...
class AppModel: ObservableObject {
    ...
    // MARK: - Init the class and setup the Core Data subscriptions
    ...
    // MARK: - Setup Core Data persistent container

    let persistentContainer: NSPersistentContainer = {
        /* Pretty straight copy of default implementation in XCode templates */
        ...
        print("Returning Core Data container ...")
        return container
    }()
}
